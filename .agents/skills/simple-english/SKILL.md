...
metadata:
  ...
  upstream_path: skills/simple-english
---

# Simple English

> **Project override for swag (this repository).**
> This vendored skill carries one project-level change: **rule 1.14 and the
> spelling note in The Document now read "Use British English spelling"
> instead of American English spelling.** All other rules are unchanged
...
**Project override:** use British English spelling (rule 1.14). Read `references/spelling.md` for the spelling table and the rules for collective nouns, date formats, and quoted text.

`references/word-swaps.md` maps the overused words to plain ones. For an error message, a runbook, an incident report, release notes, a commit message, or UI copy, read `references/use-cases.md` first: it names the mode and the pattern for each.
...
- `references/spelling.md` — project override: British English spelling table (added by swag)
